...
const upload = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        handleAnalysis({companyName: companyName as string, jobTitle: jobTitle as string, jobDescription: jobDescription as string, file});
        ...
        <section className="main-section">
            <div className="page-heading py-16">
                ...
                {isProcessing ? (
                    ...
                    <h2>Upload your resume to get AI-powered analysis and optimization suggestions</h2>
                )}
                {!isProcessing && (
